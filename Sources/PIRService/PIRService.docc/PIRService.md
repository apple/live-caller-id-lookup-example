...
The main purpose of this example service is to give a functional example that can be used to try out the feature.
...
> <doc:PrivateInformationRetrieval/ParameterTuning> to learn how to adjust the
